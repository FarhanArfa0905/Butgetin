...
class IncomeTrackingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_income_tracking, container, false)
        ...
        val datePickerDialog = DatePickerDialog(
            requireContext(),
            R.style.CustomDatePickerDialogIncome,
        ...
        btnSave.setOnClickListener {
            ...
            val familyId = "yourFamilyIdHere" // Provide the familyId (You may need to pass this dynamically)
            val type = "income" // Set the type to "income"
            ...
            // Add transaction using ViewModel
    ...
    private fun showCategoryDialog(etCategory: EditText) {
        val dialogView = LayoutInflater.from(requireContext()).inflate(R.layout.category_income, null)
